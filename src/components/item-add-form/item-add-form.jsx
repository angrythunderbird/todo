  ...
  render() {
    return (
      <div className="item-add-form">
        <input type="text" placeholder="tape task" className="form-control item-add-input" />
        <button
        className="item-add-form-btn btn btn-info"
        onClick={() => this.props.onItemAdded('Task')}>
